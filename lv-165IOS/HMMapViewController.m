...
- (void)viewDidLoad {
  ...
  NSLog(@" rating of points %@",
        [NSString stringWithFormat:@"%ld", (long)self.ratingOfPoints]);
...
- (void)viewWillAppear:(BOOL)animated {
  ...
  //    alloc]initWithAnnotations:_clusteredAnnotations];
  //    [self.clusteringManager displayAnnotations:_clusteredAnnotations
  //    onMapView:_mapView];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
  ...
  if ([segue.identifier isEqualToString:@"showSettingsViewController"]) {
    ...
    HMFiltersViewController *destViewController =
        segue.destinationViewController;
...
- (void)actionDescription:(UIButton *)sender {
  ...
  NSString *str = [NSString
      stringWithFormat:@"%ld",
                       (long)((HMMapAnnotation *)annotationView.annotation)
                           .idPlace];
...
- (void)printPointWithContinent {
  ...
  NSPredicate *ratingPredicate = [NSPredicate
      predicateWithFormat:@"%@ => rating  AND rating >= %@",
                          [NSString
                              stringWithFormat:@" %ld", (long)maxForPoint],
                          [NSString
                              stringWithFormat:@" %ld", (long)minForPoint]];
